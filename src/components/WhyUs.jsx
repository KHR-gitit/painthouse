...
<section className="text-gray-600 body-font py-32 ">
  ...
  <div className="container px-5 pt-32 mx-auto flex flex-wrap">
    <div className="flex flex-wrap w-full">
      ...
      <img className="lg:w-3/5 md:w-1/2 object-cover object-center rounded-lg md:mt-0 mt-12" src="https://mcintoshpainters.com.au/wp-content/uploads/2019/10/Copy-of-LINCOLN-ROAD-ESSENDON-3.jpg?id=807" alt="step" />
    </div>
  </div>
</section>
    )
